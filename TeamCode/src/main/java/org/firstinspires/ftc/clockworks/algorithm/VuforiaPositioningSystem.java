...
/**
 * Position detector that uses Vuforia to locate itself on the game area
 * Navigation targets are used
 */
public class VuforiaPositioningSystem {
    ...
    //location of the phone on the robot
    ...
    /**
     * Initialise the Vuforia Positioning system.
     * Utilizes phone's camera
     */
    public void init() {
